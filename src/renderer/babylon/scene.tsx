...
export const BabylonScene = forwardRef<BabylonSceneRef>((props, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        ...
        importVoxels: (voxels: Array<{ position: BABYLON.Vector3; color: string }>) => {
            ...
            voxels.forEach((voxelData, index) => {
                ...
                const shadowGen = sceneRef.current!.lights.find(light => light instanceof BABYLON.DirectionalLight)?.getShadowGenerator();
                if (shadowGen) {
